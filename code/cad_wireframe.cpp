...
QOpenGLShaderProgram* CAD_wireframe::s_program = Q_NULLPTR;
int CAD_wireframe::s_positionLoc,
    CAD_wireframe::s_normalLoc,
    CAD_wireframe::s_texCoordLoc,
    CAD_wireframe::s_modelMatrixLoc,
    CAD_wireframe::s_viewMatrixLoc,
    CAD_wireframe::s_projectionMatrixLoc,
    CAD_wireframe::s_lightViewMatrixLoc,
    CAD_wireframe::s_lightProjectionMatrixLoc,
    CAD_wireframe::s_lightPositionLoc,
    CAD_wireframe::s_modelViewNormalMatrixLoc,
    CAD_wireframe::s_shadowTypeLoc,
    CAD_wireframe::s_count,
    CAD_wireframe::IsWireframe,
    CAD_wireframe::s_color = 0;

CAD_wireframe::CAD_wireframe( QMatrix4x4& modelMatrix,
...
CAD_wireframe::~CAD_wireframe( void )
{
...
void CAD_wireframe::render(GLWidget *widget)
{
    if(mask){
        s_program->bind();
        m_vertexBuffer.bind();
...
void CAD_wireframe::renderShadow(GLWidget *widget)
{
    m_vertexBuffer.bind( );
...
void CAD_wireframe::setVertexAttribute(int attributeLocation, GLenum elementType, quint32 elementSize, quint32 offset)
{
...
int  CAD_wireframe::checkData(PointNormal point,double x,double y,double z)
{
...
double CAD_wireframe::CalNormalAngle(double a1,double a2,double a3,double b1,double b2,double b3)
{
    double angle;
...
bool CAD_wireframe::checkNormal(PointNormal point,PointNormal _point)
{
...
void CAD_wireframe::SolveInvisible(PointNormal& point)
{
...
void CAD_wireframe::CreateModel()
{
    for(int i = 0 ; i<(int)Normal.size() ; i++ ){
